...
const EXECUTIVES = [
  ...
  { gen: 11, years: '2026', current: true, members: [
    ...
    { role: '교육부장', name: '강지호', photo: '', quote: '' },
    { role: '교육부장', name: '김태형', photo: '', quote: '' } ] }
];
